...
def main():
    files = os.listdir('../data/OCR效果性能测试_raw_process/')
    print("当前目录内容:")
    for file in files:
        print(file)
        input_file = "../data/OCR效果性能测试_raw_process/{}".format(file)
        output_file = "../data/OCR效果性能测试_raw_process/{}_processed.json".format(file)
